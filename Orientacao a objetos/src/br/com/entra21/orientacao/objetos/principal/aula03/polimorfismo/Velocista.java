...
public class Velocista extends Atleta { // minha classe Velocista pegando atributos da minha super-Classe Atleta String
										// tipoPista;
	String marcaCalcado;
	String tipoPista;

	public Velocista() { // construtor vazio } public Velocista(String tipoPista, String marcaCalcado) {
							// // construtor com meus atributos da classe Velocista
		super();
