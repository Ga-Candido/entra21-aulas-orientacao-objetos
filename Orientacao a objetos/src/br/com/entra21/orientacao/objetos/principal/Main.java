...
import br.com.entra21.orientacao.objetos.principal.aula04.interfaces.Veiculo;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		do {
			...
			default:
				System.out.println("Preste atenção");
				break; 
	...
	public static void learningPolimorfismo() {
		...
		messi.comemorarVitoria();
		messi.aprenderComADerrota();

		Nadador cleidomar = new Nadador("Cleidomar", (byte) 38, 15, 14, "mar", "sunga");
		cleidomar.comemorarVitoria();
		cleidomar.aprenderComADerrota();
	...
	public static void aprenderClassesPolimorfismo() {
		...
		sergioMichael.comemorarVitoria(); // procura primeiro na minha classe Nadador, se não tiver busca na herança.
	...
	private static void aprenderPolimorfismoInterface() {
		...
		Gabriel.apresentarSe();
		Gabriel.alimentar("Pizza");
		Gabriel.locomover();
		Gabriel.comunicar("Heey");
		
		System.out.println("----------------------");
		
		Gato vezu = new Gato("vezu", new Pessoa("Gabriel", (byte)19, ""));
